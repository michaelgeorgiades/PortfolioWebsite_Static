...
if (!PAYPAL_CLIENT_ID) {
  console.warn("Warning: PAYPAL_CLIENT_ID not set. PayPal functionality will be disabled.");
}
if (!PAYPAL_CLIENT_SECRET) {
  console.warn("Warning: PAYPAL_CLIENT_SECRET not set. PayPal functionality will be disabled.");
}
